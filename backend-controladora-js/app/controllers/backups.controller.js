...
exports.findAll = (req, res) => {
  ...
  Backups.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
...
exports.getAllCodeFromBackup = (req, res) => {
  ...
  Backups.findAll({ where: { id_backup: req.body.id_backup } })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
...
exports.getAllCodeFromBackupBlock = (req, res) => {
  ...
  Backups.findAll({ where: { id_backup: req.body.id_backup, no_bloque: req.body.no_bloque} })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
